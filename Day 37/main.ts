...
console.log(studentGrade(85)); // output B
console.log(studentGrade(90)); // output A
...
console.log(ageGroup(12)); //  output Child
console.log(ageGroup(18)); // output Teenager
console.log(ageGroup(25)); // output Adult
