...
console.log(`Hello ${personName} would you like learn some typescript today?`);
// Q 03
// printing a person’s name in lowercase, uppercase, and titlecase.
let person_name = "Ayesha Iqbal";
